...
export default function GallaryBlock({ images }: GallaryBlockProps) {
  ...
  return (
    <div className="relative -mx-4 mb-8 sm:-mx-6 md:-mx-0 md:mt-4 lg:mt-6 lg:mb-14">
      ...
      <Button
        ...
        variant="outline"
        onClick={handleClick}
        className="absolute right-3 bottom-3 !bg-white px-2 py-1.5 text-sm !font-bold leading-4 text-gray-dark md:right-5 md:bottom-5 xl:py-2 2xl:px-3 2xl:text-base 3xl:right-8 3xl:bottom-8 3xl:px-4 3xl:leading-6 4xl:px-5 4xl:py-2.5"
      >
