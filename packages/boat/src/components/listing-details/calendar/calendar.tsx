...
export default function Calendar({
  ...
  return (
    <div className={clsx('relative w-full', className)}>
      <button
        onClick={prevMonths}
        className="absolute left-0 -top-1.5 rounded-full p-2 text-sm hover:bg-gray-lightest"
      >
        <ChevronLeftIcon className="h-auto w-5" />
      </button>
      <button
        onClick={nextMonths}
        className="absolute right-0 -top-1.5 rounded-full p-2 text-sm hover:bg-gray-lightest"
      >
