...
export default function PromotionalBlock() {
  ...
  return (
    <BannerBlock
      ...
      title={t('yourCareTitle')}
      description={t('yourCareDesc')}
      className="from-black/10 to-black/60 before:absolute before:top-0 before:left-0 before:z-10 before:h-full before:w-full before:bg-gradient-to-b md:before:rounded-2xl md:before:bg-gradient-to-r xl:before:hidden 4xl:!py-[132px]"
