        ...
        <label className="block   text-base font-bold leading-7">
          ...
          >
            {startIcon && (
              <div
                className={clsx(
                  'absolute top-0 left-0 flex h-full items-center justify-center bg-transparent p-1 leading-normal rtl:right-0 rtl:left-auto',
                  startIconClickable
                    ? 'z-[2] cursor-pointer'
                    : 'pointer-events-none',
            ...
            <input
              ...
              className={clsx(
                ...
                !placeholder ? 'placeholder:opacity-0' : undefined,
                clearable ? inputClearableClasses.base : undefined,
                clearable
                  ? endIcon
                    ? inputClearableClasses.hasEndIcon[size]
                    : inputClearableClasses.size[size]
                  : undefined,
                clearable || startIcon || endIcon ? 'absolute inset-0' : undefined,
                startIcon ? inputClassesWithIcon.startPadding.size[size] : undefined,
                endIcon ? inputClassesWithIcon.endPadding.size[size] : undefined,
                error ? inputClasses.error : undefined,
                inputClassName
              )}
              {...inputProps}
            />
            ...
            {endIcon && (
              <div
                className={clsx(
                  'absolute top-0 right-0 flex h-full items-center justify-center bg-transparent p-1 leading-normal rtl:left-0 rtl:right-auto',
                  endIconClickable
                    ? 'z-[2] cursor-pointer'
                    : 'pointer-events-none',
                  inputClassesWithIcon.iconSize[size]
